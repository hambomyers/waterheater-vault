        ...
        <nav>
          <div className="container">
            <div className="nav-inner">
              <div className="nav-logo">Water Heater Plan <span>&middot; Pro Platform</span></div>
              <div className="nav-links">
                <a href="#how-it-works">How it works</a>
                <a href="#pricing">Pricing</a>
                <Link href="/pro/directory">Directory</Link>
                <Link href="/" style={{color:'rgba(255,255,255,0.3)'}}>Homeowner scan &nearr;</Link>
              </div>
        ...
        <main>
          <section className="hero">
            <div className="container">
              ...
              <p className="hero-note">AI-screened &middot; 4.5+ star Google rating required &middot; Cancel anytime</p>
            </div>
          </section>
          ...
          <section className="section" id="how-it-works">
            <div className="container">
              ...
              <p className="section-sub">Every lead comes from a homeowner who already knows their heater is aging &mdash; they asked for it.</p>
              <div className="steps">
                {[
          ...
          <section className="section" id="pricing">
            <div className="container">
              ...
              <p className="section-sub">One product. One price. Cancel anytime &mdash; no lock-in, no setup fee.</p>
              <div className="pricing-grid">
                ...
                <div className="price-card featured">
                  ...
                  <Link href="/pro/onboard" className="btn-primary" style={{width:'100%',justifyContent:'center'}}>Get started &rarr;</Link>
          ...
          <section className="section" style={{borderTop:'none',paddingTop:0}}>
            <div className="container">
              <div className="gate-card">
                ...
                <div>
                  <div className="gate-title">AI Quality Gate &mdash; 4.5+ stars required</div>
                  <div className="gate-desc">Every pro is screened by Grok AI before joining. We check your Google Business Profile reviews for rating, sentiment, and red flags. Below 4.5 stars? Application denied. Re-screened every 30 days. This isn&apos;t gatekeeping &mdash; it&apos;s what makes homeowners trust the platform.</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <div className="homeowner-strip">
            <div className="container">
              <h2>Not a plumber?</h2>
              <p>The free scanner is for homeowners. Know your water heater&apos;s exact age, remaining life, replacement cost, and recall status &mdash; in 60 seconds.</p>
              <Link href="/" className="btn-ghost">Scan my water heater free &rarr;</Link>
            </div>
          </div>
        </main>
